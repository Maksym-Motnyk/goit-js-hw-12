import{a as g,S as v,i}from"./assets/vendor-bffe7c41.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const o of e)if(o.type==="childList")for(const l of o.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&a(l)}).observe(document,{childList:!0,subtree:!0});function r(e){const o={};return e.integrity&&(o.integrity=e.integrity),e.referrerPolicy&&(o.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?o.credentials="include":e.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(e){if(e.ep)return;e.ep=!0;const o=r(e);fetch(e.href,o)}})();let c=1,u="",d=0;function w(){const t=document.querySelector(".loader");t.style.display="block"}function L(){const t=document.querySelector(".loader");t.style.display="none"}async function m(t,s=1){w();const a=`https://pixabay.com/api/?${new URLSearchParams({key:"43803497-a801e9cfe7ea9bdd19d306bb3",q:t.trim(),image_type:"photo",orientation:"horizontal",safesearch:!0,per_page:15,page:s})}`;try{const e=await g.get(a);return d=e.data.totalHits,e.data}catch(e){throw console.error("Error:",e),e}finally{L()}}function b(){c=1}function P(){c+=1}function y(){return c}function S(t){u=t}function p(){return u}function q(){return d}const f=document.querySelector(".list"),x=new v(".item-list-link",{captionsData:"alt",captionDelay:250,overlayOpacity:.8}),h=t=>{const s=t.hits.map(r=>`
      <li class="item-list">
